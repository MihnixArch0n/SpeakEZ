...
data class AppSettings(
    ...
    val guardianBackgroundMonitoringEnabled: Boolean = DEFAULT_GUARDIAN_BACKGROUND_MONITORING_ENABLED,
)
...
const val DEFAULT_GUARDIAN_BACKGROUND_MONITORING_ENABLED = true
